...
/**
 * Page for creating a new Race or editing an existing one.
 * 
 * @author ywang29
 */
public final class EditRacePage extends BasePage {
    ...
    public EditRacePage(Long raceId) {
        ...
        Form<Race> form = new Form<Race>("form", new FormModel()) {
            @Override
            protected void onSubmit() {
                Race race = getModelObject();
                getService().saveRace(race);
                if (EditRacePage.this.raceId == null) {
            ...
            super(new LoadableDetachableModel<Race>() {
                ...
                protected Race load() {
                    if (EditRacePage.this.raceId == null) {
                        ...
                        return getService().getRace(EditRacePage.this.raceId);
                    }
                }
            });
        }
